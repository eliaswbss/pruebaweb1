document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Navegación en la App (Bottom Tabs) - CORREGIDO
    navItems.forEach(item => {
        item.addEventListener('click', (e) => {
            ...
            // Quitar active de todos los items y ocultar todas las pestañas correctamente
            navItems.forEach(nav => nav.classList.remove('active'));
            tabContents.forEach(tab => {
                tab.classList.remove('active');
                tab.classList.add('hidden'); // <-- Nos aseguramos de que se oculten
            });
            ...
            // Mostrar la pestaña quitando 'hidden' y añadiendo 'active'
